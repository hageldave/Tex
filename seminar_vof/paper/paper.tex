...
\section{Variational Optic Flow}
...
As the data term is insufficient for solving this problem and would yield multiple ambiguous solutions as illustrated in \ref{fig:ambigdataterm}, the regularization term is used to overcome this inconvenience and penalize flow functions that are unlikely.
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=1.5in]{images/ambiguousflow.png}
  \caption{\label{fig:ambigdataterm} Beispielillustration.}
\end{figure}
