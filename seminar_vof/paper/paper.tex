...
To get an insight into the order selection of the algorithm with the different selection schemes, a synthetic image sequence was created from which the actual flow field could be extracted as ground truth.

\begin{figure}
\centering
\includegraphics[width=\linewidth]{images/classroom.png}
\label{fig:classroom}
\caption{Classroom sequence}
\end{figure}
