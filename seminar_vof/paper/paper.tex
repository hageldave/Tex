...
The reason for the local order adaptive scoring so high in the sintel benchmark is the fact that the sintel benchmark consists mainly on fronto-parallel motion~\cite{sintel}.
For the KITTI benchmarks the local order adaptive regularizer yields worse results than the simple second order and other adaptive regularizers.
